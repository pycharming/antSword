 ...
 *
 * $ Timers licenced with the WTFPL
...
(function($, undefined) {
    ...
    */
    ...
    // -----------------------------------------------------------------------
    var signatures = [
        ['$ Terminal', '(c) 2011-2013 jcubic'],
        ['$ Terminal Emulator' + (version_set ? ' v. ' + version : ''),
         copyright.replace(/ *<.*>/, '')],
        ['$ Terminal Emulator' + (version_set ? version_string : ''),
        ...
        if (this.length > 1) {
            ...
            $.extend(self, $.omap({
                ...
                scroll: function(amount) {
                    ...
                    if (scroll_object.prop) { // work with $ > 1.6
